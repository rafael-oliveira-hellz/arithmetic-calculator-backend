...
class GlobalExceptionHandlerTest {
    ...
    @Test
    void handleInternalErrorExceptionShouldReturnInternalServerError() {
    ...
    @Test
    void urlNotFoundShouldReturnNotFound() {
    ...
    @Test
    void notFoundShouldReturnNotFound() {
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    void loginFailedShouldReturnBadGateway() {
        HttpServletRequest request = mock(HttpServletRequest.class);
        LoginFailedException ex = new LoginFailedException("Login failed");
        ResponseEntity<String> response = exceptionHandler.loginFailed(ex, request);
        assertEquals(HttpStatus.BAD_GATEWAY, response.getStatusCode());
        assertEquals("Login failed", response.getBody());
    }

    @Test
    void methodNotAllowedShouldReturnMethodNotAllowed() {
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    void invalidAtributeShouldReturnUnprocessableEntity() {
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    void getConstraintDefaultMessageShouldExtractErrorMessage() {
